    ...
    public partial class Utility
    {
     ...
     /*   private static double MySetLenght(Edge edge)
        ...
        */
        ...
        /// The <see cref="double"/>.
        /// </returns>
        private static double MyDistanceTwoPoint(Array firstPoint, Array secondPoint)
        {
        ...
        /// The <see cref="double"/>.
        /// </returns>
        private static double MyDistanceParallelPlane(Face2 firstFace, Face2 secondFace)
        {
            double distance;
            double[] firstPoint;
            double[] secondPoint;
        ...
        /// The <see cref="double"/>.
        /// </returns>
        private static double MyDistanceOfNonParallelPlane(Face2 firstFace, Face2 secondFace, out double distanceMax)
        {
            ...
            var listVertexFirstFace = MyGetVertexFromFace(swSafeFirstEntity);
            double[] firstPoint;
            double[] secondPoint;
            var firstNormal = MyGetNormalForPlaneFace(firstFace, out firstPoint);
            var secondNormal = MyGetNormalForPlaneFace(secondFace, out secondPoint);
